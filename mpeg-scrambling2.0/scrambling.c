...
void startScrambling(){
    ...
    /////////////////////////////////////////////////////////////////////////////////
    char command[150];
    sprintf(command, "java -Djava.library.path=C:/opencv-3.2.0/build/bin -jar ./bin/Scrambling.jar %d %d %s %d", CImage->Width,CImage->Height, "bin/temp/", CurrentFrame-StartFrame);
    system(command);
