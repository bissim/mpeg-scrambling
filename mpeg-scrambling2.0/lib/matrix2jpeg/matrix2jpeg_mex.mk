...
MAKEFILE = matrix2jpeg_mex.mk

include matrix2jpeg_mex.mki


SRC_FILES =  \
	matrix2jpeg_initialize.c \
...
MEX_FILE_NAME_WO_EXT = matrix2jpeg_mex
...
SYS_INCLUDE += -I "/home/lorenzo/esempi_matlab/codegen/mex/matrix2jpeg"
SYS_INCLUDE += -I "/home/lorenzo/esempi_matlab"
...
%.$(OBJEXT) : /home/lorenzo/esempi_matlab/codegen/mex/matrix2jpeg/%.c
	$(CC) $(CCFLAGS) "$<"



%.$(OBJEXT) : /home/lorenzo/esempi_matlab/codegen/mex/matrix2jpeg/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
