...
public class Scrambling {
	...
	public static void main(String[] args) throws Exception {
		...
		/*
		 * L'applicazione Scrambling prende esattamente 4 parametri:
		 * Il primo ed il secondo parametro contiene la dimensione del frame wxh
		 * Il terzo paramentro è la directory contenente i tre file Y,U,V
		 * Il quarto paramentro contiene un identificativo del frame (presumibilmente il numero
		 * del frame all'interno dell'mpg da cui proviene
		 */
		...
		if(args.length != 4){
			throw new Exception("Passaggio dei parametri non corretto!");
		}
		...
		System.out.println("Scrambling...  frame: "+n_frame);
		System.out.println("Apro il file "+fileY);
		System.out.println("Apro il file "+fileU);
		System.out.println("Apro il file "+fileV);
		...
		input = new Scanner(new File(fileY));
        i = 0;
        j = 0;
        matrix = new int[h][w];
        block = 0;
